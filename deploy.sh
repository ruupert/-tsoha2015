...
rsync -z -r $DIR/app $DIR/assets $DIR/doc $DIR/config $DIR/lib $DIR/sql $DIR/vendor $DIR/index.php $DIR/composer.json $USERNAME@lakka.kapsi.fi:htdocs/$PROJECT_FOLDER
